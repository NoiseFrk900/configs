...
# 9-12-20 I changed from 1000 and 2000 to 2000 and 4000
HISTSIZE=2000
HISTFILESIZE=4000
...
## EVERYTHING FOLLOWING IS ADDED BY ME
# files in the /opt folder because they are not packaged 
# these files coule just be in ~/bin as I am the only user
export PATH=/opt/df_linux:$PATH
